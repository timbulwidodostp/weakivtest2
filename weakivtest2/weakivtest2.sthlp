...
{phang2}import excel "https://raw.githubusercontent.com/timbulwidodostp/weakivtest2/main/weakivtest2/weakivtest2.xlsx", sheet("Sheet1") firstrow clear"{p_end}
{phang2}{stata "tsset id year" : . tsset id year}{p_end}
{phang2}{stata "qui xtivreg2 ys k (n=l.n l2.n), fe small first" : . qui xtivreg2 ys k (n=l.n l2.n), fe small first}{p_end}
{phang2}{stata "weakivtest2" : . weakivtest2 }{p_end}
{phang2}{stata "qui ivreg2 d.ys d.k (d.n=ld.n ld2.n), small first" : . qui ivreg2 d.ys d.k (d.n=ld.n ld2.n), small first}{p_end}
{phang2}{stata "weakivtest2" : . weakivtest2 }{p_end}
...
{p 4 4 2}
{cmd:Timbul Widodo}{break}
www.youtube.com/@amalsedekah{break}
